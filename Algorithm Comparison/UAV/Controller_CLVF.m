function Controller_CLVF(block)
...
function Output(block)
    ...
    alpha = 200;            %??? so fucking large
    w = -alpha*theta_e;    % From Pothen, 2017, JGCD, Eq.50
    ...
    if ending_bool 
        ...
        disp('CLVF Terminating condition met. Terminating simulation...');
